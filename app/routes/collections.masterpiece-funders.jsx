  ...
  return (
    <div className="page-container">
      ...
      <div className="page-sidebar">
        <a className="back-link" style={{ marginLeft: "4vw", marginTop: "4vh" }} href="/collections/alistair-cooke">&lt; Back to Masterpiece Collection</a>
      </div>
        ...
        <div className="page-body">
          ...
          <p>
            <a align="right" className="treasury-bio-image-container">
              <img className="half-image right" src="https://s3.amazonaws.com/openvault.wgbh.org/treasuries/AndyAndLinda2.jpg" />
            </a>
          ...
          <p>  
            <img className="treasury-neh-image" align="right" src="https://s3.amazonaws.com/openvault.wgbh.org/treasuries/NEH-Preferred-Seal820.jpg" />
