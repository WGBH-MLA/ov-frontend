...
export default function SpecialCollections() {
  ...
  let sidebar
  if(specs.sections){
    sidebar = renderSidebar("specialcollection", specs.sections)
  }

  let titleBar
  if(specs.title){
    titleBar = renderPageTitleBar(specs.title, specs.hero_image)
  }
  ...
  if(specs.author){
    let byline = (
      <div className="author-byline">
        By { specs.author.name }
      </div>
    )
    collectionAuthor = (
      <div className="page-authorbubble-container">
        { renderAuthorBubble(specs.author) } { byline }
      </div>
    )
  }
    ...
    <div>
      <div className="page-container">
        ...
        <div className="page-body-container">
          { collectionAuthor }
          <div className="page-body" dangerouslySetInnerHTML={{ __html: specs.body }} />
        </div>
